<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master/master2.master" AutoEventWireup="true" CodeFile="~/Controller/EliminarEmpleado.aspx.cs" Inherits="View_EliminarEmpleado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div class="row" style="padding:30px 10px 10px 10px">
    ...
    <div class="col l12 m12 s12">
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataSourceID="adminODS" ForeColor="Black" GridLines="None" OnRowCommand="GridView1_RowCommand">
      ...
      <asp:ObjectDataSource ID="adminODS" runat="server" SelectMethod="listarUsuarios" TypeName="DAusuario">
        <SelectParameters>
          <asp:Parameter DefaultValue="3" Name="rol" Type="Int32"/>
        </SelectParameters>
